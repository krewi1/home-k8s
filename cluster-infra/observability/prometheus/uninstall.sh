...
print_warning "Data in Garage bucket 'thanos' will NOT be deleted"
echo ""
...
if kubectl get namespace observability &> /dev/null; then
    ...
    kubectl delete -f garage-secret.yaml --ignore-not-found=true
...
echo "  garage bucket delete --yes thanos"
